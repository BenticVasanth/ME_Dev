    ...
    <div>
      <div className='container-fluid mt-2'>
        <div className='card text-center p-2' style={{ backgroundColor: "#992e93" }}>
          <div className="card-text h4 fw-bold text-white"  > BOOKS REQUEST </div>
        </div>
        ...
        <div className="row mt-2 justify-content-center">
          <div className="col-md-6 mt-4">
            ...
            <form action="">
              ...
              <div class="input-group  mb-3">
                <input type="text" class="form-control p-3" placeholder="Book Title" aria-label="Username" aria-describedby="basic-addon1" />
              </div>
              ...
              <div class="input-group mb-3">
                <textarea class="form-control" rows="5" placeholder="About Book " aria-label="With textarea"></textarea>
              </div>
